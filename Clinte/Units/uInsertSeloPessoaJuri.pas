...
type
  ...
  public
   ...
   procedure alterar(selo:Int64; valor:Double; lei, natureza:string);
...
procedure TFInsertSeloPessoaJuri.alterar(selo: Int64; valor:Double; lei, natureza:string);
begin
edSelo.Text := IntToStr(selo);
edValor.Text := FormatFloat('###0.00',valor);
edCodLei.Text := lei;
Self.selo := selo;
edNatureza.Text := natureza;
Self.ShowModal;
end;
