inherited FRelatorioPadrao: TFRelatorioPadrao
  Caption = 'Relat'#243'rio Padrao'
  ClientHeight = 142
  OnCreate = FormCreate
  ExplicitWidth = 380
  ExplicitHeight = 170
  ...
  object gpbData: TGroupBox
    ...
    object dataInicio: TDateTimePicker
      ...
      Width = 106
      Height = 21
      Date = 40943.739462256940000000
      Time = 40943.739462256940000000
      TabOrder = 0
    end
    object dataFinal: TDateTimePicker
      ...
      Width = 106
      Height = 21
      Date = 40943.741587060180000000
      Time = 40943.741587060180000000
      TabOrder = 1
    end
  end
  object Relatorio: TfrxReport
    ...
    ReportOptions.CreateDate = 40943.747284479170000000
    ReportOptions.LastChange = 40943.747284479170000000
