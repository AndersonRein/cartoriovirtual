     ...
     begin
       try
        ...
        if conclusao.getTipoConclusao <= 1 then
          intimacao.concluir(cdsIntimacaoSemConclusaoCODIGO.AsInteger, conclusao.getTipoConclusao, cdsIntimacaoSemConclusaoPROTESTO.AsInteger, conclusao.getData, DateToStr(getDiaProtesto))
        else
          intimacao.concluir(cdsIntimacaoSemConclusaoCODIGO.AsInteger, conclusao.getTipoConclusao, cdsIntimacaoSemConclusaoPROTESTO.AsInteger, DateToStr(getDiaProtesto));
        TTransacao.commit;
        ShowMessage(SUCESSO);
