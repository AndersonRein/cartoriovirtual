...
uses
  ...
  Vcl.ImgList, Vcl.ToolWin, frxCtrls, richedit, uTData, uTRegPessoaJuridica;
...
begin
 ...
 cdsCadastroTITULACAO.AsString := LowerCase(usuario.getFuncao);
 if dsCadastro.State in [dsInsert] then
 cdsCadastroORDEM.AsInteger := registro.getOrdem;
end;
...
cdsCadastroNATURESA.AsString := insert.getNatTitulo;
end;
